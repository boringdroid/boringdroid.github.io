 ...
 * Add .navbar-ontop class to navbar when the page is
 * scrolled to top.
 * Make sure to add this script to the <head> of page
...
(function() {
  ...
  document.write(
      '<style id=\'temp-navbar-ontop\'>' +
      '.navbar {opacity:0; transition: none !important}' +
      '</style>',
  );
